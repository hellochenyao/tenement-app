<template>
	<mescroll-uni bottom="100" :up="upOption" :down="downOption" @down="downCallback" @up="upCallback" @init="mescrollInit">
		<swiper class="swiper" :style="{height:swiperHeight}" :indicator-dots="indicatorDots" :interval="interval" :duration="duration">
		    <swiper-item>
				<view class="swiper-item-tab">
					<!-- 新增的微博 -->
		    ...
		    <swiper-item>
		        <view class="swiper-item-tab uni-bg-green">B</view>
		    </swiper-item>
		    <swiper-item>
		        <view class="swiper-item-tab uni-bg-blue">C</view>
		    </swiper-item>
		</swiper>
		...
		methods: {
			...
			downCallback(){
				...
				this.getListDataFromNet(0, 1, (curPageData)=>{
					...
					// #ifdef H5
					console.log("a")
					this.top=uni.upx2px(0)+"px"; // H5的高度需加上 88的标题栏
					// #endif
