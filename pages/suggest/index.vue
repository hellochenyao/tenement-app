    ...
    export default {
        ...
        methods: {
							...
							uni.uploadFile({
								...
								success: (uploadFileRes) => {    
									if(uploadFileRes.statusCode == 200){  
										...
										this.images = this.images.concat(uploadFileRes.resourceUrl);
									}
								},
								fail:(e)=>{
									console.log(e)
            ...
            send() { //发送反馈
				...
				let remark = this.sendDate.content+" " + this.sendDate.contact
                this.$store.dispatch("sendAdvice",{
					image:this.images.toString(),
					userId,
					remark,
					star:this.sendDate.star,
					tipOffsType:"TIPOFFS_SUGGEST",
				}).then(res=>{
					console.log(res) 
				})
				.catch(e=>{ 
